...
module.exports = {
  ...
  description: 'Generates an image based on a prompt using Flux AI',  // Description
  ...
  async execute(senderId, args, pageAccessToken) {
    ...
    const apiUrl = `https://kaiz-apis.gleeze.com/api/flux?prompt=${encodeURIComponent(prompt)}&apikey=4fbe737b-9f02-4151-9290-34e3d83c7c4f`;  // API endpoint with the prompt
